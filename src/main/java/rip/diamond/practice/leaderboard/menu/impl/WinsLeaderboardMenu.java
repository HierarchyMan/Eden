...
public class WinsLeaderboardMenu extends LeaderboardMenu {
    ...
    public String getPrePaginatedTitle(Player player) {
        return CC.translate(Eden.INSTANCE.getMenusConfig().getConfig().getString("leaderboard-menu.items.titles.wins"));
    }
    ...
    public Map<Integer, Button> getAllPagesButtons(Player player) {
        ...
        getPlugin().getLeaderboardManager().getWinsLeaderboard().values().stream()
